	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<div class="col">
			<div class="card h-100">
				<router-link to="/items" class="card-link">
					...
					<div class="card-footer">
						<small class="text-muted">{{ warrantyLabel(stats.items_count) }} in the
							database</small>
					</div>
				</router-link>
			</div>
		...
		<div class="col">
			<div class="card h-100">
				<router-link to="/shops" class="card-link">
					<div class="card-body pt-4">
					...
					<div class="card-footer">
						<small class="text-muted">{{ shopLabel(stats.shops_count) }} in the
							database</small>
					</div>
				</router-link>
			</div>
		...
		<div class="col">
			<div class="card h-100">
				<router-link to="/database" class="card-link">
					<div class="card-body pt-4">
						<div class="card-icon">💾</div>
