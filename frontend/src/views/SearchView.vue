				...
				<form @submit.prevent="submitItemEdit(item.id)">
					<div class="modal-body text-start">
						...
						<div class="mb-2">
							...
							<input v-model="editItemForms[item.id].amount" type="number" min="0"
								class="form-control form-control-sm" />
						</div>
						<div class="mb-2">
							<label class="form-label">Price per piece</label>
							<input v-model="editItemForms[item.id].price_per_piece
						...
						<div class="mb-2">
							...
							<input v-model="editItemForms[item.id].purchase_date
								" type="date" class="form-control form-control-sm" required />
						</div>
						<div class="mb-2">
							<label class="form-label">Warranty length (months)*</label>
							<input v-model="editItemForms[item.id].warranty_months
								" type="number" min="1" class="form-control form-control-sm" required />
						</div>
