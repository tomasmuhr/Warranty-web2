<template>
	...
	<template
		v-for="shop in shops"
		:key="`shop-modals-${shop.id}`"
	>
		<div
			class="modal fade"
			:id="`shopItems_${shop.id}`"
			tabindex="-1"
			aria-hidden="true"
		>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<warranty-items-table
							...
							:under-warranty="
								warrantyItems[shop.id].under_warranty
							"
							:out-of-warranty="
								warrantyItems[shop.id].out_of_warranty
							"
						/>
					</div>
				</div>
					...
					<form @submit.prevent="submitEdit(shop.id)">
						<div class="modal-body text-start">
							<div class="mb-2">
								<label class="form-label">Name*</label>
								<input
									v-model="editForms[shop.id].name"
									class="form-control form-control-sm"
									required
								/>
							</div>
							<div class="mb-2">
								<label class="form-label">Street</label>
								<input
									v-model="editForms[shop.id].street"
									class="form-control form-control-sm"
								/>
							</div>
							<div class="mb-2">
								<label class="form-label">City</label>
								<input
									v-model="editForms[shop.id].city"
									class="form-control form-control-sm"
								/>
							</div>
							<div class="mb-2">
								<label class="form-label">Zip code</label>
								<input
									v-model="editForms[shop.id].zip_code"
									class="form-control form-control-sm"
								/>
							</div>
							<button
